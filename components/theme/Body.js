...
const Body = ({ selectedField = {}, feedData = [] }) => {
  return (
    <div className="sm:mx-[3vw] md:mx-[6vw] xl:mx-[10vw] mx-5 sm:mx-0">
      <h1 className={`text-4xl py-4 ${yanone.className}`}><span className="text-red-500">Theme:</span> {selectedField.label}</h1>
